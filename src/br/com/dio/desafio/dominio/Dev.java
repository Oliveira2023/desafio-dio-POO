...
public class Dev {
    private String nome;
    private Set<Conteudo> conteudosInscritos = new LinkedHashSet<>();//colocando na ordem de conclusão
    ...
    public void progredir() {
        ...
        if (conteudo.isPresent()) {
            ...
            System.err.println("Você não está mantriculado em nenhum curso");
        }
    }
